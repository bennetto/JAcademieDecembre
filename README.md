...
git clone https://github.com/bennetto/JAcademieDecembre.git
...
Dans le gestionnaire de base de données, copier le contenu du fichier 'createTableMusicDB.sql' dans le champ en haut à droite, puis cliquez sur Execute SQL.
